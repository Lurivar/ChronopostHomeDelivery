...
class ChronopostHomeDelivery extends AbstractDeliveryModule
{
    ...
    public function postActivation(ConnectionInterface $con = null)
    {
        ...
        $defaultConfig = [
            ...
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_LABEL_DIR => THELIA_LOCAL_DIR . 'chronopost',
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_LABEL_TYPE => "PDF",
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_PASSWORD => null,
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_TREATMENT_STATUS => "3",
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_PRINT_AS_CUSTOMER_STATUS => "N",
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_EXPIRATION_DATE => null,

            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_SHIPPER_NAME1 => null,
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_SHIPPER_NAME2 => null,
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_SHIPPER_ADDRESS1 => ConfigQuery::read("store_address1"),
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_SHIPPER_ADDRESS2 => ConfigQuery::read("store_address2"),
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_SHIPPER_COUNTRY => null,
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_SHIPPER_CITY => ConfigQuery::read("store_city"),
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_SHIPPER_ZIP => ConfigQuery::read("store_zipcode"),
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_SHIPPER_CIVILITY => null,
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_SHIPPER_CONTACT_NAME => null,
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_SHIPPER_PHONE => ConfigQuery::read("store_phone"),
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_SHIPPER_MOBILE_PHONE => null,
            ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_SHIPPER_MAIL => ConfigQuery::read("store_email"),
        ];
        ...
        $dir = self::getConfigValue(ChronopostHomeDeliveryConst::CHRONOPOST_HOME_DELIVERY_LABEL_DIR, null);
        $fs = new Filesystem();
        if (!is_dir($dir)) {
            $fs->mkdir($dir);
        }
